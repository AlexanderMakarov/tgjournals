...
public record JournalDto(Long id, String answer, LocalDateTime createdAt, String questionText, String sessionDate) {
	public static JournalDto from(Journal journal) {
		return new JournalDto(journal.id(), journal.answer(), journal.createdAt(),
